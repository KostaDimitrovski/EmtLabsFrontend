...
const BookEdit = (props) => {
    ...
    return (
        <div className="row mt-5">
                ...
                <form onSubmit={onFormSubmit}>
                    <div className="form-group">
                        ...
                        <input type="text"
                               ...
                               name="name"
                               required
                               placeholder={props.book.name} // update placeholder value
                    ...
                    <div className="form-group">
                        ...
                        <input type="text"
                               ...
                               required
                               placeholder={props.book.availableCopies} // update placeholder value
                               onChange={handleChange}
                        />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <select name="authorId" className="form-control" onChange={handleChange}>
                            {props.authors.map((term) => {
                                if (
                                    props.book.author &&
                                    props.book.author.id !== undefined &&
                                    props.book.author.id === term.id
                                ) {
                                    return (
                                        <option key={term.id} value={term.id} selected>
                                            {term.name}
                                        </option>
                                    );
                                } else {
            ...
            {/*<div>{props.book.author.id}</div>*/}
            {/*<div>*/}
            {/*    <h1>{props.book.author.id}</h1>*/}
            {/*</div>*/}
        </div>
    )
